...
const BannerTeamBuilding = () => {
  return (
    <section className="relative w-full h-[50vh] min-h-[400px] z-11 overflow-hidden">
      {/* Background Image */}
      <Image
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center text-white px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link
            ...
            className="px-8 py-3 bg-teal-500 hover:bg-teal-600 text-white font-semibold rounded-lg transition-colors duration-300"
          >
          ...
          <Link
            href="/contact"
            className="px-8 py-3 border-2 border-white/70 hover:border-white hover:bg-white/10 text-white font-semibold rounded-lg transition-all duration-300"
          >
            Contact Us
          </Link>
        </div>
