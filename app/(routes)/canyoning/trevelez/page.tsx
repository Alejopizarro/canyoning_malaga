...
export default function Page() {
  const trevelez = excursions[6];
  const excursionHero = {
    mainImage: trevelez.mainImage,
    images: trevelez.images,
    title: trevelez.title,
    subtitle: trevelez.subtitle,
    categoryPath: trevelez.categoryPath,
    categoryText: trevelez.category,
    rating: {
      value: trevelez.rating.value,
      totalReviews: trevelez.rating.reviews,
    },
  };
