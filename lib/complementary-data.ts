...
export const complementaryData: Record<string, ComplementaryData> = {
  ...
  guadalmina: {
    subtitle:
      "Benahavís Canyoning: Canyon of the Angosturas in Guadalmina River Walk Guided Adventure",
    description:
  ...
  "rio-verde": {
    ...
    days: "From April 1st to October 31th",
    mainImage: {
    ...
    level: "moderate",
    specialPrice: "Open Group Price: Every Wed & Fri from June to September.",
    province: "Granada",
    duration: 4.5,
  ...
  zarzalones: {
    ...
    level: "moderate",
    province: "Málaga",
    specialPrice: "Open Group Price: Every Tue & Thu in July and August.",
    duration: 4,
    minimumAge: 9,
  ...
  "rio-verde-xpro": {
    ...
    category: "Canyoning",
    specialPrice:
      "Private Experience! Price depends on group size. Transfer included.",
    categoryPath: "canyoning",
    isDisponible: true,
  },
  ...
  buitreras: {
    ...
    category: "Canyoning",
    categoryPath: "canyoning",
    specialPrice: "Private Experience! Price depends on group size.",
    duration: 6,
  ...
  ronda: {
    ...
    images: [
      ...
      {
        src: "/VF-Ronda-10.webp",
        alt: "Via Ferrata Ronda - Challenging sections in via ferrata ronda",
      },
      {
        src: "/VF-Ronda-11.webp",
        alt: "Via Ferrata Ronda - Climbing the iconic Tajo cliffs in via ferrata ronda",
      },
      {
        src: "/VF-Ronda-12.webp",
        alt: "Via Ferrata Ronda - Climbing the iconic Tajo cliffs in via ferrata ronda",
      },
    ],
    isOffer: false,
  ...
  casares: {
    ...
    videoYoutube: "https://www.youtube.com/watch?v=ofV6ZisZZ00",
    specialPrice: "Minimum 3 people. Available on Mon & Fri.",
    days: "Mon | Fri",
    mainImage: {
      src: "/casares-1.webp",
  ...
  "el-chorro": {
    ...
    categoryPath: "via-ferrata",
    duration: 4,
    specialPrice: "Minimum 4 people. Available on Mon, Wed & Fri.",
    minimumAge: 14,
  ...
  "la-concha": {
    ...
    rating: { value: 0, reviews: 0 },
    level: "advanced",
    specialPrice: "Minimum 2 people. Available Mon to Sat.",
    province: "Málaga",
    category: "Hiking",
    categoryPath: "hiking",
    duration: 6.5,
  ...
  "kayak-puerto-banus": {
    ...
    days: "Tue | Thu | Sat",
    specialPrice:
      "Open Group Price: Every Tue, Thu & Sat from May to October. Children under 6 y.o. FREE!",
    mainImage: {
